...
PRODUCTS = [
    {
        ...
        "price": 850,
        "category": "building",
        "file_image": "https://images.unsplash.com/photo-1577789099564-8bf48d9ea15d?w=400",
        "stock": 500
    },
    {
        ...
        "price": 750,
        "category": "building",
        "file_image": "https://images.unsplash.com/photo-1583001903870-4ab9639d66cb?w=400",
        "stock": 1000
    },
    {
        ...
        "price": 550,
        "category": "building",
        "file_image": "https://images.unsplash.com/photo-1567016432779-094069958ea5?w=400",
        "stock": 800
    },
    {
        ...
        "price": 1200,
        "category": "building",
        "file_image": "https://images.unsplash.com/photo-1580388768056-2bf284cd53d6?w=400",
        "stock": 300
    },
    {
        ...
        "price": 120,
        "category": "building",
        "file_image": "https://images.unsplash.com/photo-1590075407676-b2f0ccb8c69c?w=400",
        "stock": 5000
    },
    {
        ...
        "price": 3500,
        "category": "building",
        "file_image": "https://images.unsplash.com/photo-1580542221268-0bb055bce9e9?w=400",
        "stock": 200
    },
    {
        ...
        "price": 4500,
        "category": "paints",
        "file_image": "https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=400",
        "stock": 150
    },
    {
        ...
        "price": 2800,
        "category": "paints",
        "file_image": "https://images.unsplash.com/photo-1562259949-e1816dedd812?w=400",
        "stock": 100
    },
    {
        ...
        "price": 850,
        "category": "paints",
        "file_image": "https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=400",
        "stock": 80
    },
    {
        ...
        "price": 2200,
        "category": "paints",
        "file_image": "https://images.unsplash.com/photo-1589330273590-245f6d604155?w=400",
        "stock": 120
    },
    {
        ...
        "price": 3200,
        "category": "paints",
        "file_image": "https://images.unsplash.com/photo-1590266893557-1e6edfecb35b?w=400",
        "stock": 60
    },
    {
        ...
        "price": 450,
        "category": "paints",
        "file_image": "https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=400",
        "stock": 200
    },
    {
        ...
        "price": 550,
        "category": "hardware",
        "file_image": "https://images.unsplash.com/photo-1586864387967-d02ef85d93e0?w=400",
        "stock": 150
    },
    {
        ...
        "price": 8500,
        "category": "hardware",
        "file_image": "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=400",
        "stock": 45
    },
    {
    ...
    },
    {
        ...
        "price": 250,
        "category": "hardware",
        "file_image": "https://images.unsplash.com/photo-1579174541026-64e1c6eaf93a?w=400",
        "stock": 300
    },
    {
        ...
        "price": 4200,
        "category": "hardware",
        "file_image": "https://images.unsplash.com/photo-1572210552361-b939152dc161?w=400",
        "stock": 40
    },
    {
        ...
        "price": 850,
        "category": "plumbing",
        "file_image": "https://images.unsplash.com/photo-1584622781867-8afa0ab3a796?w=400",
        "stock": 500
    },
    {
        ...
        "price": 3500,
        "category": "plumbing",
        "file_image": "https://images.unsplash.com/photo-1590779032306-983786a0de1e?w=400",
        "stock": 50
    },
    {
        ...
        "price": 350,
        "category": "electrical",
        "file_image": "https://images.unsplash.com/photo-1562663474-6cbb3eaa4d4f?w=400",
        "stock": 1000
    },
    {
        ...
        "price": 650,
        "category": "electrical",
        "file_image": "https://images.unsplash.com/photo-1627485933178-9283db6aecfd?w=400",
        "stock": 150
    },
    {
        ...
        "price": 4500,
        "category": "general",
        "file_image": "https://images.unsplash.com/photo-1567459169667-05cd47e4edb2?w=400",
        "stock": 30
    },
    {
        ...
        "price": 850,
        "category": "general",
        "file_image": "https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?w=400",
        "stock": 200
    },
]
...
def seed(reset=False):
    ...
    try:
        if reset:
            ...
            print(f"🗑  Cleared {len(PRODUCTS)} existing products")
            db.commit()

        existing = db.query(Product).count()
        if existing > 0 and not reset:
            print(f"📊 Database already has {existing} products.")
            ans = input("Delete them and reseed with fresh data? (y/n): ").strip().lower()
            if ans != "y":
                print("❌ Aborted")
                return
            db.query(Product).delete()
        ...
        for (cat,) in categories:
            if cat:
                cat_count = db.query(Product).filter(Product.category == cat).count()
                print(f"   - {cat}: {cat_count} products")
    finally:
        db.close()
